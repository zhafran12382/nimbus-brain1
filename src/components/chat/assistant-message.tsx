...
function getToolDisplay(name: string, phase: "start" | "result"): { icon: string; text: string } {
  const map: Record<string, { icon: string; startText: string; resultText: string }> = {
    ...
    get_notifications: { icon: "🔔", startText: "Fetching notifications...", resultText: "Notifications loaded" },
    summarize_notifications: { icon: "🧾", startText: "Summarizing notifications...", resultText: "Summary ready" },
    mark_all_notifications_read: { icon: "✅", startText: "Marking all as read...", resultText: "All marked read" },
    delete_notifications: { icon: "🗑️", startText: "Deleting notifications...", resultText: "Notifications deleted" },
