...
export function ChatHistory({
  ...
  const sidebarContent = (closeOnSelect: boolean, showCloseButton: boolean) => (
    <>
      {/* Header */}
  ...
  return (
    <>
      {desktopVisible && (
        <aside className="hidden lg:flex w-[280px] border-r border-border-subtle glass flex-col">
        ...
        {open && (
          <>
            ...
            <motion.aside
              ...
              className="fixed inset-y-0 left-0 z-[70] w-[280px] max-w-[85vw] flex flex-col glass border-r border-border-subtle lg:hidden"
            >
