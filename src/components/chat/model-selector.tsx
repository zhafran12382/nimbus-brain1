...
export function ModelSelector({ providerId, modelId, onModelChange }: ModelSelectorProps) {
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      >
        <span className="max-w-[160px] truncate text-white/80 font-medium">{currentModel?.name || "Select model"}</span>
