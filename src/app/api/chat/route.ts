...
function getModeInstruction(mode: string): string {
  switch (mode) {
    ...
    case 'think':
      return '\n\n[MODE: THINK]\nDalam mode ini, lakukan penalaran mendalam SECARA INTERNAL. JANGAN tampilkan proses berpikir atau chain-of-thought ke user. Berikan hanya jawaban final yang jelas, terstruktur, dan lengkap.\n[/MODE]';
    case 'flash':
